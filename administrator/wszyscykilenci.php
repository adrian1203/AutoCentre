...
?>
    ...
    <body>
        ...
        <nav>
            ...
            <div class="pusty"></div>
            <h2>Wszyscy kilenci w serwisie </h2>
            <?php
       
     require_once "../conect.php";
   $polaczenie = new mysqli($host, $db_user, $db_password, $db_name);
   $rezultat=$polaczenie->query("SELECT * FROM customer ");

   echo"<table cellpadding=5 border=1>";
   echo"<tr><th>Imie</th><th>Nazwisko</th><th>Miejscowosc</th><th>Kod </th><th>Ulica</th><th>Email</th></tr>";
   while ($wiersz=$rezultat->fetch_assoc()) {
        echo"<tr>";
          echo "<td>".$wiersz['name']."</td>"; 
         echo "<td>".$wiersz['surname']."</td>"; 
          echo "<td>".$wiersz['city']."</td>"; 
            echo "<td>".$wiersz['cod']."</td>"; 
            echo "<td>".$wiersz['street']."</td>"; 
